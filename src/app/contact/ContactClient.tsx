...
export function ContactClient({ pageSeo }: { pageSeo?: any }) {
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden border border-card-border shadow-2xl bento-card">
                <div className="aspect-[4/3] w-full relative">
                  <img
                    src={pageSeo?.bannerImage || "https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"}
              ...
              <div className="mt-8 space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <div className="flex w-full rounded-2xl border border-white/15 bg-black/40 overflow-hidden focus-within:border-[#ffbe00] focus-within:ring-2 focus-within:ring-[#ffbe00]/20 transition-all">
                      <div className="relative shrink-0">
                        <select
                          value={currency}
                          onChange={(e) => setCurrency(e.target.value)}
                          disabled={loading}
                          className="h-full pl-4 pr-8 py-3.5 bg-transparent text-sm text-white focus:outline-none appearance-none cursor-pointer border-r border-white/15"
                        >
                          <option value="USD" className="bg-[#1a1122]">USD $</option>
                          <option value="GBP" className="bg-[#1a1122]">GBP £</option>
                          <option value="EUR" className="bg-[#1a1122]">EUR €</option>
                          <option value="PKR" className="bg-[#1a1122]">PKR Rs</option>
                          <option value="AUD" className="bg-[#1a1122]">AUD $</option>
                          <option value="CAD" className="bg-[#1a1122]">CAD $</option>
                        </select>
