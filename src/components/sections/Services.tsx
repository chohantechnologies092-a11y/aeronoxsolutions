      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-20 text-center">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4.5 py-2 rounded-full bg-[#ffbe00]/20 border border-[#ffbe00]/40 text-[#24182e] text-xs font-black uppercase tracking-[0.25em] mb-6 backdrop-blur-md shadow-[0_0_20px_rgba(255,190,0,0.15)]"
          >
            <Sparkles size={13} className="text-[#24182e]" />
            Our Capabilities
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            ...
            className="text-4xl md:text-6xl font-black text-[#1a1122] tracking-tight leading-[1.1] max-w-4xl mx-auto"
          >
